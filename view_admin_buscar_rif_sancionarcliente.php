...
if (!$rol == 1) {
    ...
    FINALIDAD:       Buscar el RIF para luego establecer estatus sanción cliente
    ...
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script><!-- cargar imagen  -->
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            } else
                            {
                                ...
                                setTimeout(function () {
                                       window.location = "view_admin_sancionarcliente.php?rifcli="+rifcli;
                                }, 5000);
                            }
                        },
                ...
                <div class="box-body">
                    ...
                    <div class="span14">
                        ...
                        <div class="well login-register">
                            ...
                            <!-- Buscar Rif y Razón Social   <form class="form-horizontal" name="formContacto" id="formulario" method="post" action="includes/buscarRifReactivarCliente.php" >
                            -->
                            ...
                            <form id="form1">
                                ...
                                <button  id="reactivar" class="btn btn-danger" >Buscar para sancionar</button>
                            ...
                            <div class="alert-success" style="display: none" align="center">
                                El cliente está registrado, espere mientras se redirecciona!
