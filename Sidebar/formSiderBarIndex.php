                    ...
                    <ul id="nav">
                        ...
                        <li><a href="contactos.php" class="br-yellow"><i class="icon-user"></i>Contacto</a></li> 
                         <li><a href="acercade.php"class="br-purple"><i class="icon-camera"></i>Acerca de Nosotros</a></li> 
                          <li><a href="sitemap.php"class="br-orange"><i class="icon-sitemap"></i>Mapa del sitio</a></li> 
                           <li><a href="FAQ.php"class="br-blue"><i class="icon-user-md"></i>Preguntas frecuentes</a></li>
                    </ul>
