...
if (!isset($email)) {
    ...
    <script language="javascript" type="text/javascript">
        $(document).ready(function() {
            $('select[name="estado"]').attr('disabled', 'disabled');
            $('select[name="estatus"]').attr('disabled', 'disabled');
            $('select[name="roles"]').attr('disabled', 'disabled');


            $('select[name="estado"]').on('change', function() {
                $('estadoser').removeAttr('disabled');
            });
            $('select[name="estatus"]').on('change', function() {
                $('estatuscli').removeAttr('disabled');
            });
            $('select[name="roles"]').on('change', function() {
                $('rolAdmin').removeAttr('disabled');
            });
        });
    </script>  
    <?php
                            ...
                            <fieldset> 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php if ($file['tblsit_usr_in_estatus_usr'] == 1) { ?>
                                            Activo
                                            <input  readonly type="hidden" class="input-large" id="estadoser" name="estatusUsr" value="<?php echo $file['tblsit_usr_in_estatus_usr'] ?>">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <select class="input-large"   name="estatusUs" id="estado"  required>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php if ($file['tblsit_usr_in_estatus_cliente'] == 1) { ?>
                                            Registrado
                                            <input  type="hidden" class="input-large" id="estatucli" name="estatusCli" value="Registrado">
                                        <?php } else if ($file['tblsit_usr_in_estatus_cliente'] == -1) { ?>
                                            Eliminado
                                            <input readonly type="hidden" class="input-large" id="estatucli"  name="estatusCli" value="Eliminado">
                                        <?php } else if ($file['tblsit_usr_in_estatus_cliente'] == 0) { ?>
                                            Sancionado
                                            <input  readonly type="hidden" class="input-large" id="estatucli"  name="estatusCli" value="Sancionado">
                                        <?php } else if ($file['tblsit_usr_in_estatus_cliente'] == 2) { ?>
                                            Pendiente
                                            <input  readonly type="hidden" class="input-large" id="estatucli"  name="estatusCli" value="Pendiente">
                                        <?php } else if ($file['tblsit_usr_in_estatus_cliente'] == 3) { ?>
                                            Reactivado
                                            <input  readonly type="hidden" class="input-large" id="estatucli"  name="estatusCli" value="Reactivado">
                                        <?php } ?>
                                    </div>
                                </div>   
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ¿Desea cambiar el estatus del cliente?
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php if ($file['tblsit_usr_id_rol_usr'] == 1) { ?>
                                            Administrador
                                            <input readonly  type="hidden" class="input-large" id="rolAdmin" name="rolAdmin" value="Administrador">

                                        <?php } else if ($file['tblsit_usr_id_rol_usr'] == 2) { ?>
                                            <input readonly  type="text" class="input-large" id="rolAdmin" name="rolAdmin" value="Autorizador I">
                                        <?php } else if ($file['tblsit_usr_id_rol_usr'] == 3) { ?>
                                            <input readonly  type="text" class="input-large" id="rolAdmin" name="rolAdmin" value="Autorizador II">
                                        <?php } else if ($file['tblsit_usr_id_rol_usr'] == 4) { ?>
                                            Cliente
                                            <input readonly  type="hidden" class="input-large" id="rolAdmin" name="rolAdmin" value="Cliente">
                                        <?php } else if ($file['tblsit_usr_id_rol_usr'] == 5) { ?>
                                            <input readonly  type="text" class="input-large" id="rolAdmin" name="rolAdmin" value="Vendedor">
                                        <?php } ?>
                                    </div>
                                </div>   
                                <div class="control-group">
