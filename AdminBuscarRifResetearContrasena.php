...
<div class="content">
                    ...
                    <div class="span14">
                        <div class="box-body">
                            ...
                            <div class="page-title" align="left">
                                <h4>Buscar RIF para resetear contraseña</h4>
        ...
        <div class="well login-register">
            <h6>Resetear la contraseña</h6>
            <hr />
            
                <!-- Buscar Rif y Razón Social-->
                <form class="form-horizontal"  method="get" action="includes/buscarRifResetearContrasena.php" >
                    <!-- RIF -->
                    ...
                    <div class="control-group">
                        ...
                        <a class="btn btn-danger" href="AdminMenuPrincipal.php">Volver</a>
