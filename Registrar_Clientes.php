                ...
                <div class="span12">  
                    ...
                    ***********************************************************  "/^([VEJPG]{1})([0-9]{9}$)/"           trim(strtoupper(str_replace("-","",$RIF)))
                     ...
                     //   include 'includes/ConexionPGSQL.php';
                                ...
                                if (isset($empresa) && isset($riff)) {
                                    ...
                                    <fieldset> 
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input readonly type="text" class="input-large" id="rif" name="rif" value="<?php echo $_GET["rif"] ?>" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input readonly type="text"  size="100"class="input-large" id="empresa" name="empresa" value="<?php echo $empresa ?>" >
                        ...
                        echo "<script language='JavaScript'> alert(' Problema con contribuyente.seniat.gob.ve en linea')                 
                                           location.href = 'Registrar_Clientes_Sin_Seniat.php?rif=$_GET[rif]';   exit();                                                          
                                        </script> ";
                    }
