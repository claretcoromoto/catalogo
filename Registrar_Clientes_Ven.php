 ...
 header("Location: login.php");
    ...
    if (isset($_GET["rif"])) {
        ...
        if (isset($datosFiscales->code_result)) {
            ...
            $riff = $rif;
            if (!strcasecmp($empresa, '')==0  && isset($_GET['rif'])) {
                            ...
                            <h5>Registrar Cliente</h5>
                                        ...
                                        <fieldset> 
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="mayuscula" readonly type="text" class="input-large"  id="rif" name="rif" value="<?php echo $_GET["rif"] ?>" >
                ...
                <?php
            } else if (strcasecmp($empresa, '')==0) {
                header('Location: Registrar_Clientes_Sin_Seniat_Ven.php?rif='.$_GET['rif'].' ');
