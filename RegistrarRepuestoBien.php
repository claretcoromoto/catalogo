...
include_once "includes/ConexionPGSQL.php";
include 'procesarArchivos.php';
extract($_REQUEST);
error_reporting(E_ALL ^ E_NOTICE);

$procesar= new procesarArchivos();

//$error= $procesar->mensajesErrorArchivos($error_code);
$archivo= $procesar->moverArchivos($archivos);
