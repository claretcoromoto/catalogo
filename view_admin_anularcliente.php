                        ...
                        //    $rif=$_REQUEST['rifcli'];
                            ...
                            <div class="well login-register">
                                ...
                                <form class="form-horizontal"  method="post" action="controlador/controller_admin.php" >
                                    <!-- RIF -->
                                    <div class="control-group">
                                        <input type = "hidden" name="accion" id = "accion"    value ='4' required/>
                                    ...
                                    <div class="form-actions">
                                        <!-- Buttons -->
                                        <button class="btn btn-danger" type="submit"  name="submit" class="btn">Anulación del cliente</button>
