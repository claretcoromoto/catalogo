    ...
    <div class="content">
        ...
        <div class="mainbar">
            ...
            <div class="span14">
                ...
                ORDER BY tblsit_municipio_nb_municipio ASC ";
                            $result = pg_query($sql);
                            $comboMunicipio = '';
                            while ($row = pg_fetch_array($result)) {
                                $comboMunicipio .=" <option value=" . $row['tblsit_municipio_id_municipio'] . "> " . $row['tblsit_municipio_nb_municipio'] . "[" . $row['tblsit_estado_nb_estado'] . "]</option>";
                            }
                            ?>
                                        ...
                                        <div class="box-body">
                                            <form action="<?php echo $loginFormAction ?>" method="get">
                                                <div class="control-group">
                                                    <label class="control-label" for="busqueda">Buscar  Municipio[Estado]</label>
                                                    <div class="controls">
                ...
                ORDER BY tblsit_municipio_nb_municipio ASC  ";
                                                        ...
                                                        while ($row = pg_fetch_array($result)) {
                                                            ...
                                                            <tr> 
                                                                <!--
                                                                -->  <form class="form-search s-widget"   method="post" action="includes/ActualizarMunicipio.php" >
                                                            ...
                                                            <td id="nbc"><input name="municipio" type="text" id="campo" disabled="disabled" value="<?php echo $row['tblsit_municipio_nb_municipio'] ?>" ></td> 
                                                            <td id="nbm" disabled><?php echo $row['tblsit_estado_nb_estado'] ?></td> 
                                                            <input  readonly name="id_estado" type="hidden"  value="<?php echo $row['tblsit_estado_id_estado'] ?>">
                                                            <td>
