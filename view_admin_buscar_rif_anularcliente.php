                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            } else
                            {
                                ...
                                setTimeout(function () {
                                    window.location = "view_admin_anularcliente.php?rifcli="+rifcli;
                                }, 5000);
                            }
                        },
                    ...
                    <div class="span14">
                        ...
                        <div class="well login-register">
                            ...
                            <form id="form1">
                                ...
                                <button  id="reactivar" class="btn btn-danger" >Buscar para anular</button>
