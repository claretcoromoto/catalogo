...
class  formARegistrarUsuario{
    
    
    function __construct() {
        ;
    }
    function formUsuario($rif, $idusr, $empresa, $make, $model, $options){
        echo '
...
<form    name="QForm"   id="QForm" class="form-horizontal" method="post" action="includes/RegistrarClientes.php" />
                                        ...
                                        <fieldset> 
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input readonly type="text" class="mayuscula" pattern="(^([VEJPG]{1})([0-9]{9}$)" class="input-large" id="rif" name="rif" value="'.$rif.'">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input readonly type="text"  size="100"class="input-large" id="empresa" name="empresa" value="'.$empresa.'" >
