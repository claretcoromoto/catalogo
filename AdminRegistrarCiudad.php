...
if (!$rol == 1 ) {
    ...
    <div class="content">
                ...
                <div class="mainbar">
                    ...
                    <div class="span14">
                        <div class="box-body">
                            ...
                            <div class="span14">
                    <?php
                    $sqlcat = "SELECT * FROM tblsit_municipio ORDER BY nb_municipio ASC";
                    $result = @pg_query($sqlcat);
                    $ciuda = '';
                    while ($row = pg_fetch_array($result)) {
                        $ciuda .=" <option value=" . $row['id_municipio'] . "> " . $row['nb_municipio'] . "</option>";
                    }
                    ?> 
            ...
            <hr />
                    ...
                    <form class="form-horizontal"  method="get" action="includes/RegistrarCiudad.php" >
                        <!-- RIF -->
                        <div class="control-group">
                            <label class="control-label" for="ciudad">Ciudad</label>
                            <div class="controls">
                                <input  class="input-medium"  pattern="^[a-zA-Z\-_ ]{3,20}$"  type="text" title="Por favor, introduzca el nombre de la ciudad"  placeholder="Caracas, Maracaibo" name="ciudad" id="ciudad"  required autofocus />
                            </div>
                        </div>   
